...
{
    class PhtoPaActiveDebtGridViewModell
    {
        String FromPhName;
        String ToPhName;
        String MedName;
        ...
        public PhtoPaActiveDebtGridViewModell(int debtId, String fromPhName, string toPaName, int amount, int medId, String MedName)
        {
            this.debtId = debtId;
